...
cropped_image_output = os.path.join(parent_dir, '3.Cropped_faces')
        ...
        if len(probabilities) == 0:
            ...
            for i in range(len(probabilities)):
                if probabilities[i] < 0.6:
                    ...
                    cropped_face = cropped_frame[top_left_y:bottom_right_y, top_left_x:bottom_right_x]

                    cv2.imwrite(cropped_image_video_output + "\\" + str(idx) + '.jpg', cropped_face)
